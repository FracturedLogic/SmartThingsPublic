 ...
 *  Data Logger
 *
 *  Original Author: jgrey
 *  Forked to work with Logstash by rchoquette
 *  Date: 2016-01-16
 *  
 *  Log data to a HTTP POST Endpoint.
 *  Works as-is with Logstash (uses a single json parameter in the body of the POST).
